            ...
            >
              ...
              >
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-6">
                  ...
                  <p className="text-blue-100 mt-2">Classes 8-10</p>
                </div>
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-display font-semibold text-blue-800 mt-4 mb-3">Key Features:</h3>
              ...
              >
                <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-6">
                  ...
                  <p className="text-orange-100 mt-2">Classes 11-12 & Droppers</p>
                </div>
                <div className="p-6">
                  <p className="text-gray-700 mb-4">
                  ...
                  <h3 className="text-xl font-display font-semibold text-orange-600 mt-4 mb-3">Program Structure:</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start">
              ...
              >
                <div className="bg-gradient-to-r from-blue-500 to-blue-700 p-6">
                  ...
                  <p className="text-blue-100 mt-2">Medical Entrance Preparation</p>
                </div>
                <div className="p-6">
                  <p className="text-gray-700 mb-4">
                  ...
                  <h3 className="text-xl font-display font-semibold text-blue-700 mt-4 mb-3">Key Highlights:</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <span className="text-orange-500 mr-2">•</span>
              ...
              >
                <div className="bg-gradient-to-r from-orange-600 to-orange-700 p-6">
                  ...
                  <p className="text-orange-100 mt-2">For Aspiring Champions</p>
                </div>
                <div className="p-6">
                  <p className="text-gray-700 mb-4">
                  ...
                  <h3 className="text-xl font-display font-semibold text-orange-700 mt-4 mb-3">Program Benefits:</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <span className="text-blue-500 mr-2">•</span>
